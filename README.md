# Mastering Backend - Music Streaming API: Build Your Own Spotify

![Design preview for the Music Streaming API: Build Your Own Spotify](https://pub-63da695b9ece47c5b3b49bd78b86d884.r2.dev/Music%20Streaming%20API%20Build%20Your%20Own%20Spotify.png)
...
The project is to build **Music Streaming API: Build Your Own Spotify** and get the front end working (the front end has already integrated the API).
...
Your task is to Build Your Own Spotify. You will find an SQLite database file called `db.sqlite` inside the root folder. You will find the front end of each project on the project description page. 
